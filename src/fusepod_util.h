...
/**
 * Returns a string which has been trimmed/stripped and has had it's reserved characters removed.
 * If the string ends up being empty, unknown is returned. unknown defaults to "Unknown".
 */
string fusepod_check_string (const string & s, const string & unknown = "Unknown");

/**
 * Returns a copy of the string. Use this function to save space.
 * All strings called from this function are copied if they have not been asked for
 * before for future reference.
 */
